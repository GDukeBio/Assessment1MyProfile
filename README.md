...
<h2 style="color:DarkRed;"> Motivation </h2>
...
<p> The skills required would be HTML and some form of app building language like JavaScript. I am unsure what is required to link the two of them together as I have zero experience in coding, but it can be done. Finding the skills required would be relatively easy as I could hire someone with the skills to build it. The required hardware would be a computer for writing the code, and a server to store it all on. Internet would be required to gather the information for the comics, their release dates, authors etc. I would also need the ability to incorporate already built apps into the system like maps</p>
<img align="right" src="images/Maps.png" width="50" height="50"/>
<h2> Outcome </h2>
